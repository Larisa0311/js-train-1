...
function getUserStatus(age) {
  ...
  else if (age >= 18 && age < 65) {return "Дорослий"}
...
function getVariableType(variable) {
  ...
  return "Це " + (typeof(variable) == 'number' ? "число" :
  (typeof(variable) == 'string' ? "рядок" :
  (typeof(variable) == 'Boolean' ? "булеве значення" : "інший тип")));
}
